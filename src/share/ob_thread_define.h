...
TG_DEF(TransactionExecutorPool, TransactionExecutorPool, "", TG_STATIC, QUEUE_THREAD, ThreadCountPair(1, 1), 99999)
TG_DEF(StatisticsCollectorPool, StatisticsCollectorPool, "", TG_STATIC, QUEUE_THREAD, ThreadCountPair(1, 1), 99999)
TG_DEF(TxnScheduler, TxnScheduler, "", TG_STATIC, OB_THREAD_POOL, ThreadCountPair(1, 1))
